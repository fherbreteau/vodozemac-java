...
pub fn register_jni(env: &mut JNIEnv, class: &JClass) -> jni::errors::Result<()> {
    env.register_native_methods(
        ...
        &[
            ...
            VODOZEMAC_SAS_ESTABLISHED_SAS_CALCULATE_MAC_INVALID_BASE64_JNI.into(),
...
#[ffi]
#[sret]
pub fn vodozemac_sas_established_sas_calculate_mac_invalid_base64(
    sas: &EstablishedSas,
    #[expand] input: &[u8],
    #[expand] info: &[u8],
) -> CSlice<u8> {
    ...
    sas.calculate_mac_invalid_base64(input, info).into_bytes().into()
}
