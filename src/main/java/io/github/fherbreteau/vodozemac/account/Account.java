...
public class Account implements AutoCloseable {
    ...
    /**
     * Create a new {@code VodozemacAccount} with new random identity keys.
     */
    public Account() {
    ...
    /**
     * Get the IdentityKeys of this {@code VodozemacAccount}
     * 
    ...
    /**
     * Get a copy of the {@code VodozemacAccount}'s public Ed25519 key
    ...
    /**
     * Get a copy of the {@code VodozemacAccount}'s public Curve25519 key
     * @return a base 64 representation of the public Curve25519 key
     */
     ...
     * @return a string representation of the {@code VodozemacAccount}
     */
    ...
    /**
     * Restore a {@code VodozemacAccount} from a previously saved AccountPickle deserialized from a JSON structure.
     * @param pickleData
     * @return a {@code VodozemacAccount} object
     */
    ...
    /**
     * Create an {@code VodozemacAccount} object by unpickling an account pickle in libolm legacy pickle format
    ...
    /**
     * Create an {@code VodozemacAccount} object from a dehydrated device.
     * 
    ...
    /**
     * Close the {@code VodozemacAccount} by releasing its associated native resources 
     * 
     * {@InheritDoc}
     */
    @Override
