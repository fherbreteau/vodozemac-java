...
- **Package Documentation**: Added `package-info.java` files describing the purpose and contents of every Java package (`account`, `backup`, `ecies`, `exception`, `megolm`, `olm`, `sas`, `types`, and the root package) (#106)
